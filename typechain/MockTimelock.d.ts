...
interface MockTimelockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setNow(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "setNow", data: BytesLike): Result;
...
export class MockTimelock extends BaseContract {
  ...
  callStatic: {
    ...
    setNow(_now: BigNumberish, overrides?: CallOverrides): Promise<void>;
